		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title ",
									"targetURL": "#testprojectb1503-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testprojectb1503-display": {
								"semanticObject": "testprojectb1503",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.projectb1503",
									"url": sap.ui.require.toUrl("test/projectb1503")
								}
							}
						}
					}
