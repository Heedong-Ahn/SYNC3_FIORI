		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON CRUD",
									"targetURL": "#projectb1504-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb1504-display": {
								"semanticObject": "projectb1504",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb1504",
									"url": sap.ui.require.toUrl("projectb1504")
								}
							}
						}
					}
