		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncprojectb1501-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncprojectb1501-display": {
								"semanticObject": "syncprojectb1501",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.projectb1501",
									"url": sap.ui.require.toUrl("sync/projectb1501")
								}
							}
						}
					}
